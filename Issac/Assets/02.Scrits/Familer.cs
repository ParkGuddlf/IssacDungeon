...
public class Familer : MonoBehaviour
{
    ...
    {
        GameObject bullet = Instantiate(familiar.bulletPrefabs, transform.position, Quaternion.identity) as GameObject;
        ...
        bullet.GetComponent<Rigidbody2D>().velocity = new Vector3(posX, posY, 0);
    }
}
